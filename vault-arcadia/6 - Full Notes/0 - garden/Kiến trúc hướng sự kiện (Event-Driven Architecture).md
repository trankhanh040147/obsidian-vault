SRC: https://viblo.asia/p/kien-truc-huong-su-kien-event-driven-architecture-zXRJ8n2dVGq
...
Ứng dụng của chúng ta tạo ra một event, tuy nhiên nó không hề biết _Ai_ sẽ xử lí event đó, _khi nào_, _Ở đâu_ và _Xử lí như thế nào_.
...
- **Events tồn tại dưới hình thức records**. Events và records là hai thuật ngữ khác nhau về mặt kĩ thuật. Event dùng để chỉ một hành động hoặc một điều gì đó xảy ra. Record chứa thông tin mô tả về event. Ở đây chúng ta thường sử dụng thuật ngữ _event_ để chỉ đến record của nó.
